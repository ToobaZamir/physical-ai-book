...
**Scalable with Free-Tier Services**: Architecture must leverage Neon Postgres, Qdrant Cloud Free within resource constraints (~500MB Neon, 1GB Qdrant).
**Tech Stack Consistency**: Implementation must use OpenAI Agents/ChatKit, FastAPI, Neon Postgres, Qdrant Cloud Free with Docusaurus integration.
