...
- [ ] T001 Create project structure per implementation plan ensuring book-content only retrieval
- [ ] T002 Initialize Python project with OpenAI Agents/ChatKit, FastAPI, Qdrant dependencies (per constitution)
...
**Constitution Alignment**: [How this user story aligns with core principles - Accuracy via Content-Specific Retrieval, User-Centric for AI/Robotics Students, etc.]
...
- [ ] T012 [P] [US1] Contract test for book-content retrieval in tests/contract/test_[name].py
- [ ] T013 [P] [US1] Integration test for student-focused response in tests/integration/test_[name].py
- [ ] T014 [P] [US1] Privacy compliance test to verify no query storage in tests/integration/test_privacy.py

### Implementation for User Story 1

- [ ] T015 [P] [US1] Create book content model in src/models/book_content.py
- [ ] T016 [P] [US1] Create query model in src/models/query.py (no storage persistence)
- [ ] T017 [US1] Implement content retrieval service in src/services/content_retrieval.py
- [ ] T018 [US1] Implement response generation service in src/services/response_generation.py
- [ ] T019 [US1] Add privacy-compliant endpoint in src/api/chat.py
- [ ] T020 [US1] Add validation for book-topic relevance
- [ ] T021 [US1] Add logging for user story 1 operations (no query content logged)
...
- [ ] T024 [P] [US2] Test for ROS 2/Gazebo/Isaac Sim query handling in tests/integration/test_topics.py
...
- [ ] T031 [P] [US3] Resource limit compliance test in tests/integration/test_scalability.py
...
- [ ] T035 [US3] Add free-tier resource monitoring
...
- [ ] TXXX [P] Documentation updates in docs/ with privacy and free-tier considerations
- [ ] TXXX Code cleanup and refactoring to ensure no query storage
- [ ] TXXX Performance optimization within free-tier constraints
- [ ] TXXX [P] Additional unit tests for constitution compliance in tests/unit/
- [ ] TXXX Security hardening for privacy compliance
- [ ] TXXX Run quickstart.md validation ensuring all constitution principles are met
- [ ] TXXX Test accuracy against book content (≥90% as per constitution)
- [ ] TXXX Validate <5s response time (as per constitution)
